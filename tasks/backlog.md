...
> Última actualización: 2026-07-29 (sesión 8). Borrador vivo; agregar ideas con ID nuevo y fase sugerida.
...
| C-05 | Copy/paste en ChainPreview | idea | S–M | Alta | Ver detalle abajo. |
...
- [ ] H-01 (speed)
- [ ] C-04
- [ ] **C-05** copy en ChainPreview (compact + selección)
